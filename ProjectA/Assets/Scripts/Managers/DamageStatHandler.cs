...
public class DamageStatHandler : MonoBehaviour
{
    //Èû
    ...
    private static WeakReference<DamageStatHandler> instance;

    private DamageStatHandler() { }

    public static DamageStatHandler Instacne {
        get
        {
            if(instance == null || instance.TryGetTarget(out DamageStatHandler singleton))
            {
                singleton = new DamageStatHandler();
                instance= new WeakReference<DamageStatHandler>(singleton);
            }
